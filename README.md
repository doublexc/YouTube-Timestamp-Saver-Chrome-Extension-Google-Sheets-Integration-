...
### 💡 คำแนะนำเพิ่มเติมสำหรับการอัปโหลดขึ้น GitHub
1. นำสคริปต์ไฟล์ `manifest.json`, `popup.html`, `popup.js` ที่เราเขียนร่วมกันก่อนหน้านี้ ใส่รวมไว้ใน Repository นี้ด้วย เพื่อให้คนอื่นหรือ HR เข้ามาตรวจดูความสะอาดเรียบร้อยของ Source Code ได้ครับ
2. สำหรับโค้ด Google Apps Script แนะนำให้สร้างไฟล์ชื่อ `apps-script.js` แยกไว้อีกหนึ่งไฟล์ในโปรเจกต์ เพื่อให้ผู้ที่สนใจสามารถก๊อปปี้สคริปต์ฝั่งหลังบ้านไปใช้งานตามได้ง่ายขึ้นครับ
